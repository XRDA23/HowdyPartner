public interface IGameLogicManager
{
    ...
    bool PlayCard(Team team, Pawn chosenPawn, CardTypeEnum cardType);

    // Process a card move when the card has multiple possible actions.
    bool PlayCardWithOptions(Team team, Pawn chosenPawn, CardTypeEnum cardType, Option choice);
    ...
    bool IsTeamCompleted(Team team);

    // Determines the winning team.
    Team GetWinnerTeam();

    // Helps a partner using a card.
    bool AssistPartner(Team team, Pawn chosenPawn, CardTypeEnum cardType);

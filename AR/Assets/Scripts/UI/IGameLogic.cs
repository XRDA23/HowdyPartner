...
namespace UI
{
    public interface IGameLogicManager
    {
        ...
        TeamEnum GetWinnerPartnersTeam();

        // Helps a partner using a card.
        bool AssistPartner(TeamEnum teamEnum, Pawn chosenPawn, CardTypeEnum cardType);
